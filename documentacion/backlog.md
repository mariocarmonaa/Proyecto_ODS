...
Como usuario, quiero gestionar Diplodocus (add/edit/delete). (CRUD Diplodocus)
Criterios: Formularios, lista con detalles salud/ubicación.
Como usuario, quiero ver/editar Resultados ambientales. (CRUD Resultados)
Criterios: Tabla editable, métricas calculadas.

Como usuario, quiero CRUD completo para todas entidades con roles (user/admin).
